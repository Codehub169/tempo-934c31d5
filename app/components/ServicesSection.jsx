...
const ServiceCard = ({ title, description, icon, index }) => {
  ...
  return (
    <div
      ref={cardRef}
      className={`bg-white/60 backdrop-blur-sm p-8 rounded-xl shadow-lg hover:shadow-xl transition-all duration-500 ease-in-out transform hover:-translate-y-1 group ${
    ...
    >
      ...
      <h3 className="text-2xl font-heading text-primary mb-3 text-center">{title}</h3>
      <p className="text-neutral-dark text-center font-sans text-sm leading-relaxed">{description}</p>
    </div>
  );
};
  ...
  return (
    <section id="services" className="py-20 md:py-32 bg-secondary/30">
      <div className="container mx-auto px-6 text-center">
        ...
        <p className="text-lg md:text-xl text-neutral-dark mb-16 max-w-2xl mx-auto font-sans">
